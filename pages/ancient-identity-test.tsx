...
import coverBgImg from '@/assets/images/yulining-character-test/cover-bg.jpg';
                ...
                {!started && !result && (
                    <section className={styles.cover}>
                        <div className={styles.coverImageWrap}>
                            <img src={coverBgImg.src} alt="" className={styles.coverImage} />
                            <div className={styles.coverOverlay} />
                        </div>
                        <div className={styles.coverContent}>
                            <div className={styles.coverLabel}>Ancient Identity Test</div>
                            <h1 className={styles.coverTitle}>测测你的职场前世</h1>
                            <p className={styles.coverSubtitle}>你在古代能活到第几集，又会以什么方式留下名字？</p>
